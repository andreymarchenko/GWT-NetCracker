...
public class property implements EntryPoint {
  ...
  public void onModuleLoad() {
    ...
    // Add the nameField and sendButton to the View
    // Use View.get() to get the entire body element
    View.get("nameFieldContainer").add(nameField);
    View.get("sendButtonContainer").add(sendButton);
    View.get("errorLabelContainer").add(errorLabel);
    View.get("resButtonContainer").add(resetButton);
